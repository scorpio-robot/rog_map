...
inline double computePathLength(const super_utils::vec_E<super_utils::Vec3f> & path)
{
  if (path.size() < 2) {
    return 0.0;
  }
...
inline super_utils::Vec3f lineBoxIntersectPoint(
  const super_utils::Vec3f & pt, const super_utils::Vec3f & pos, const super_utils::Vec3f & box_min,
...
static bool GetIntersection(
  float fDst1, float fDst2, super_utils::Vec3f P1, super_utils::Vec3f P2, super_utils::Vec3f & Hit)
{
...
static bool InBox(
  super_utils::Vec3f Hit, super_utils::Vec3f B1, super_utils::Vec3f B2, const int Axis)
{
...
// The box in this article is Axis-Aligned and so can be defined by only two 3D
// points:
//  B1 - the smallest values of X, Y, Z
//         B2 - the largest values of X, Y, Z
//  returns true if line (L1, L2) intersects with the box (B1, B2)
//  returns intersection point in Hit
inline bool lineIntersectBox(
  super_utils::Vec3f L1, super_utils::Vec3f L2, super_utils::Vec3f B1, super_utils::Vec3f B2,
