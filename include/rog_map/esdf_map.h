...
public:
  ...
  void initESDFMap(
    const Vec3i & half_prob_map_size_i, /* The input is half map size, to
                                            ensure the map size is always odds*/
